...
namespace OpenCLBenchmark
{
    public class ImageHandling
    {
        ...
        {
            // Refill images listbox
            this.FillImagesListBox();

			// Refresh the MetaLabel
			this.MetaLabel.Text = this.CurrentObject?.GetMetaString() ?? "No image selected";
		}
	...
	public class ImageObject
    {
        ...
        public int Channels => this.BitsPerPixel / 8;
        ...
        public bool OnHost => this.Img != null && this.Pointer == IntPtr.Zero;
        public bool OnDevice => this.Img == null && this.Pointer != IntPtr.Zero;
